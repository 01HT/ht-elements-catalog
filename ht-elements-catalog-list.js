  ...
  _render({ items, notFound, view, smallScreen, cartChangeInProcess }) {
    return html`
      ...
      <div id="not-found" hidden?=${!notFound ? true : false}>
        <svg viewBox="0 0 230 130" preserveAspectRatio="xMidYMid meet" focusable="false" class="style-scope yt-icon" style="pointer-events: none; display: block; width: 100%; height: 100%;">
          <g viewBox="0 0 230 130" class="style-scope yt-icon">
            <defs class="style-scope yt-icon">
              <clipPath id="clip-path" class="style-scope yt-icon">
                <path d="M3.43 126.34H227a29.17 29.17 0 0 0-5.06-24c-4.42-6.11-10-12.51-9.71-28.73s-.4-59.23-20.9-67.3c-28.87-11.37-53.18 18.05-71.57 19s-32.31-9.34-45.87-4.5-11.63 16.68-18.17 19.83-20.58.73-25.18 13.8S34.06 77.8 25 83.73c-8.82 5.75-27.62 9.32-21.57 42.61z"
                  fill="none" class="style-scope yt-icon"></path>
              </clipPath>
            </defs>
            ...
            <g clip-path="url(#clip-path)" class="style-scope yt-icon">
              ...
              <rect fill="#ffd61d" x="153.02" y="44.21" width="5.88" height="5.88" rx="1.4" ry="1.4" transform="rotate(-90 155.965 47.145)"
                class="style-scope yt-icon"></rect>
